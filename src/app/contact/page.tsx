...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-brand-dark flex flex-col pt-16">
      
      <div className="flex-1 max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-16 flex flex-col justify-center">
        <div className="text-center max-w-2xl mx-auto mb-12">
          <h1 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl bg-gradient-to-r from-brand-purple to-indigo-400 bg-clip-text text-transparent">
            Contact Us
          </h1>
          <p className="mt-3 text-sm text-brand-text-muted">
            Have questions about digital gift cards, bulk orders, or SOL payments? Drop us a message, and our customer support team will reply within 24 hours.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-6">
            <div className="glass-panel p-5 rounded-2xl border border-brand-border/40 bg-brand-card/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-brand-text-muted mt-1">support@solcart.io</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel p-5 rounded-2xl border border-brand-border/40 bg-brand-card/5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="text-xs font-bold text-white uppercase tracking-wider">Support Dashboard</h4>
                  <p className="text-[11px] text-brand-text-muted mt-1">Submit tickets here or log in to track open queries.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {success ? (
              <div className="text-center py-8 space-y-4">
                ...
                <button
                  ...
                  className="px-5 py-2 text-xs font-bold bg-brand-purple hover:bg-brand-purple/95 rounded-lg text-white mt-4"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full h-10 bg-brand-purple hover:bg-brand-purple/95 disabled:bg-brand-purple/50 rounded-lg text-xs font-bold text-white flex items-center justify-center gap-2 shadow-lg shadow-brand-purple/10 hover:shadow-brand-purple/20 transition-all"
                >
                  {loading ? (
      ...
      {/* Footer */}
      <footer className="py-6 border-t border-brand-border/40 text-center text-[10px] text-brand-text-muted">
        &copy; {new Date().getFullYear()} SOLCart. All rights reserved.
      </footer>
    </main>
  );
}
