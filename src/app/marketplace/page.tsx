...
function MarketplaceContent() {
  ...
  }, [searchTerm, selectedRetailers, selectedCategories, selectedBrands, priceRange, selectedRegion, minRating, sortBy, allProducts]);
      ...
      <div className="flex gap-8 items-start">
        ...
        <aside className="hidden lg:block w-64 shrink-0 glass-panel rounded-2xl p-6 border border-brand-border/40 sticky top-24">
          <div className="flex items-center justify-between border-b border-brand-border/40 pb-4 mb-6">
            ...
            {(selectedRetailers.length > 0 || selectedCategories.length > 0 || selectedBrands.length > 0 || priceRange !== "all" || selectedRegion !== "all" || minRating > 0 || searchTerm !== "") && (
              <button 
