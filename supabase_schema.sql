...
VALUES 
  ...
  ('staff-1', 'owner@solcart.shop', 'Sarah Owner', '', 'Owner', true, '2025-01-10T12:00:00Z'),
  ('staff-2', 'superadmin@solcart.shop', 'Alex SuperAdmin', '', 'Super Admin', true, '2025-01-11T12:00:00Z'),
  ('staff-3', 'finance@solcart.shop', 'Fred Finance', '', 'Finance Manager', true, '2025-01-12T12:00:00Z'),
  ('staff-4', 'ops@solcart.shop', 'Olivia Operations', '', 'Operations Manager', true, '2025-01-13T12:00:00Z'),
  ('staff-5', 'support@solcart.shop', 'Steve Support', '', 'Customer Support', true, '2025-01-14T12:00:00Z'),
  ('staff-6', 'fulfillment@solcart.shop', 'Frank Fulfillment', '', 'Fulfillment Manager', true, '2025-01-15T12:00:00Z'),
  ('staff-7', 'analyst@solcart.shop', 'Ana Analyst', '', 'Read-Only Analyst', true, '2025-01-16T12:00:00Z')
ON CONFLICT (id) DO NOTHING;
